...
<div class="container-fluid">
    <div class="card bg-white" >
        <div class="card-header" style="background-color:#F2F5C8">
            <p class="h2 text-center text-uppercase font-weight-bold pt-2" style="color:#333c3e; font-family:Comic Sans MS;">20IP08</p>
        </div>
        <div class="card-body container-fluid" >
            <div class="row">
                ...
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pression equilibrage : </label>
                    <input class="form-control" type="text" id="pEqui" required>
                </div>
                <div class="col-sm-6 mb-2">
                ...
                <div class="col-sm-6 mb-2">
                    <label for="code">Temp palier pompe : </label>
                    <input class="form-control" type="text" id="tpali" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Temp sortie Noria : </label>
                    <input class="form-control" type="text" id="tSor" required>
                </div>
            </div>
            <div class="row">
                <div class="col">
            ...
            <div class="row table-responsive m-auto rounded">
                <table class="table table-hover">
                    ...
                    <tr class="text-uppercase " style="background-color:#ebe6b4">
                            ...
                            <th scope="col">Pression equilibrage</th>
                            <th scope="col">Pression filtre</th>
                            <th scope="col">Niveau huile</th>
                            <th scope="col">Temp palier pompe</th>
                            <th scope="col">Temp sortie Noria</th>
                        ...
                        <tr class="text-uppercase " style="background-color:#A6CF98">
                            <th scope="col">88A</th>
                            <th scope="col">1,5a2bar </th>
                            <th scope="col">80a88bar</th>
                            <th scope="col">2,5bar</th>
                            <th scope="col"><0,15bar</th>
                            <th scope="col">80%</th>
                            <th scope="col"><84°C</th>
...
<script src="script/ip8.js" type="text/javascript"></script>
<?php
