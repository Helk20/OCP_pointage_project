...
<div class="container-fluid">
    <div class="card bg-white" >
        <div class="card-header " style="background-color:#F2F5C8">
            <p class="h2 text-center text-uppercase font-weight-bold pt-2" style="color:#333c3e; font-family:Comic Sans MS;">20IE01</p>
        </div>
        <div class="card-body container-fluid" >
            <div class="row">
                ...
                <div class="col-sm-6 mb-2">
                    <label for="code">T° entree vapeur : </label>
                    <input class="form-control" type="text" id="etVap" required>
                </div>
                <div class="col-sm-6 mb-2">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr class="text-uppercase " style="background-color:#ebe6b4">
                            ...
                            <th scope="col">T° entree vapeur</th>
...
<script src="script/Ie1.js" type="text/javascript"></script>
<?php
