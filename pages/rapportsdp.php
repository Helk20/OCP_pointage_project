...
<div class="container-fluid">
    <div class="card bg-white" >
        <div class="card-header" style="background-color:#F2F5C8">
            <p class="h2 text-center text-uppercase font-weight-bold pt-2" style="color:#333c3e; font-family:Comic Sans MS;">Gestion des Rapports SDP</p>
        </div>
        <div class="card-body container-fluid" >
            ...
            <div class="row">
                <div class="col-sm-6 mb-2">
                    <label for="prenom">Operateur : </label>
                    <input class="form-control" type="text" id="operateur" required>

                </div>
                <div class="col-sm-6 mb-2">
                    <label for="activite">Activites : </label>
                    <textarea class="form-control" type="text" id="activites" required></textarea>
                </div>
            </div>
...
<script src="script/rapportsdp.js" type="text/javascript"></script>
<?php
