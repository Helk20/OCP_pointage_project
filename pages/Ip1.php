...
<div class="container-fluid">
    <div class="card bg-white" >
        <div class="card-header" style="background-color:#F2F5C8">
            <p class="h2 text-center text-uppercase font-weight-bold pt-2" style="color:#333c3e; font-family:Comic Sans MS;">20IP01</p>
        </div>
        <div class="card-body container-fluid" >
            <div class="row">
                <div class="col-sm-6 mb-2">
                    <label for="code">Date : </label>
                    <input class="" type="number" name="id" id="id" hidden >
            ...
            <div class="row table-responsive m-auto rounded">
                <table class="table table-hover" id="tabtab">
                    <thead>
...
<script src="script/Ip1.js" type="text/javascript"></script>
