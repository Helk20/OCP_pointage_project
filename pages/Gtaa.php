...
<div class="container-fluid">
    <div class="card bg-white" >
        <div class="card-header " style="background-color:#F2F5C8">
            <p class="h2 text-center text-uppercase font-weight-bold pt-2" style="color:#333c3e; font-family:Comic Sans MS;">Gestion des GTA2</p>
        </div>
        <div class="card-body container-fluid" >
            <div class="row">
                ...
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pr. Asp Air ppe à vide 20BC01 : </label>
                    <input class="form-control" type="text" id="prVide20BC01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pr. Asp Air ppe à vide 20LC01 : </label>
                    <input class="form-control" type="text" id="prVide20LC01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Amp. Pp à vide 20BC01 : </label>
                    <input class="form-control" type="text" id="ampVide20BC01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Amp. Pp à vide 20LC01 : </label>
                    <input class="form-control" type="text" id="ampVide20LC01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pr. Aspiration 20LP01: </label>
                    <input class="form-control" type="text" id="prAspi20LP01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pr. Aspiration 20BP01: </label>
                    <input class="form-control" type="text" id="prAspi20BP01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pr. Refoulement 20LP01: </label>
                    <input class="form-control" type="text" id="prRefoulement20LP01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pr. Refoulement 20BP01 : </label>
                    <input class="form-control" type="text" id="prRefoulement20BP01" required>
                </div>
            </div>
            <div class="row">
                <div class="col">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr class="text-uppercase " style="background-color:#A6CF98">
                            ...
                            <th scope="col">Pr. Asp Air ppe à vide 20BC01</th>
                            <th scope="col">Pr. Asp Air ppe à vide 20LC01</th>
                            <th scope="col">Amp. Pp à vide 20BC01</th>
                            <th scope="col">Amp. Pp à vide 20LC01</th>
                            <th scope="col">Pr. Aspiration 20LP01</th>
                            <th scope="col">Pr. Aspiration 20BP01</th>
                            <th scope="col">Pr. Refoulement 20LP01</th>
                            <th scope="col">Pr. Refoulement 20BP01</th>
...
<script src="script/gtaa.js" type="text/javascript"></script>
<?php
