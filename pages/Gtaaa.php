...
<div class="container-fluid">
    <div class="card bg-white" >
        <div class="card-header " style="background-color:#F2F5C8">
            <p class="h2 text-center text-uppercase font-weight-bold pt-2" style="color:#333c3e; font-family:Comic Sans MS;">Gestion des GTA3</p>
        </div>
        <div class="card-body container-fluid" >
            <div class="row">
                ...
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pr. Asp Air ppe à vide 20CC01 : </label>
                    <input class="form-control" type="text" id="prVide20CC01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pr. Asp Air ppe à vide 20MC01 : </label>
                    <input class="form-control" type="text" id="prVide20MC01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Amp. Pp à vide 20CC01 : </label>
                    <input class="form-control" type="text" id="ampVide20CC01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Amp. Pp à vide 20MC01 : </label>
                    <input class="form-control" type="text" id="ampVide20MC01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pr. Aspiration 20CP01: </label>
                    <input class="form-control" type="text" id="prAspi20CP01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pr. Aspiration 20MP01: </label>
                    <input class="form-control" type="text" id="prAspi20MP01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pr. Refoulement 20CP01: </label>
                    <input class="form-control" type="text" id="prRefoulement20CP01" required>
                </div>
                <div class="col-sm-6 mb-2">
                    <label for="libelle">Pr. Refoulement 20MP01 : </label>
                    <input class="form-control" type="text" id="prRefoulement20MP01" required>
                </div>
            </div>
            <div class="row">
                <div class="col">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr class="text-uppercase " style="background-color:#A6CF98">
                            ...
                            <th scope="col">Pr. Asp Air ppe à vide 20CC01</th>
                            <th scope="col">Pr. Asp Air ppe à vide 20MC01</th>
                            <th scope="col">Amp. Pp à vide 20CC01</th>
                            <th scope="col">Amp. Pp à vide 20MC01</th>
                            <th scope="col">Pr. Aspiration 20CP01</th>
                            <th scope="col">Pr. Aspiration 20MP01</th>
                            <th scope="col">Pr. Refoulement 20CP01</th>
                            <th scope="col">Pr. Refoulement 20MP01</th>
...
<script src="script/gtaaa.js" type="text/javascript"></script>
<?php
